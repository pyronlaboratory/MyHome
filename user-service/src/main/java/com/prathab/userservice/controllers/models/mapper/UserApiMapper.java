...
/**
 * Defines a mapping between objects of different types to convert them to corresponding
 * objects in another type using Mapstruct's automatic conversion capabilities.
 */
@Mapper
