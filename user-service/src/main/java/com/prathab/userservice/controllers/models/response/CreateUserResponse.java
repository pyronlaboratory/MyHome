...
/**
 * is a response model containing unique identifier, name, and email details for
 * created users.
 * Fields:
 * 	- userId (String): in the CreateUserResponse class represents a unique identifier
 * for a created user.
